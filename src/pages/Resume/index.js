...
const ResumePage = () => {
    ...
    return (
        <div className="flex flex-col">
            <div
                className="flex flex-row  min-w-[55vw] px-10 bg-white text-black flex-wrap font-sans justify-center md:justify-left"
            >
                <div
                    ...
                    <div className="flex flex-col flex-wrap max-w-[800px] pt-6">
                        <div className='flex flex-col mb-3'>
                            ...
                            <div className='flex flex-col justify-center items-left mb-2'>
                                ...
                                <p className='font-light text-sm'>2022 - Current, 3.7</p>
                            </div>

                            <div className='flex flex-col justify-center items-left mb-2'>
                                <p className='font-medium mr-2'>Biology: Prenursing, AS <span className='font-light'>Cosumnes River College, Sacramento</span></p>
                                <p className='font-light text-sm'>2019 - 2021, 3.9</p>
                            </div>

                            <div className='flex flex-col justify-center items-left mb-2'>
                                <p className='font-medium mr-2'>Elk Grove Highschool <span className='font-light'>Elk Grove, Sacramento</span></p>
                                <p className='font-light text-sm'>2015 - 2019, 4.1 Weighted</p>
                            </div>
                        </div>
                    </div>
            ...
            <div className='flex w-full justify-center items-center text-black font-sans pb-5'>
                    <Link to="/contact/resume.pdf">
                        <p className='underline'>PDF Version</p>
                    </Link>
            </div>
        </div>
    )
