    ...
    return (
        <Layout>
            ...
            <div className='flex flex-row justify-center sm:justify-between flex-wrap w-full px-5'>
                ...
                <h2 className='text-4xl text-vs-teal font-bold'>Tony Vallescas</h2>
            ...
            <div className='flex flex-col flex-wrap px-5 max-w-lg mb-10'>
                ...
                <p className='py-4 indent-6'>
                    I'm a <span className='text-vs-teal'>full stack</span> web developer with expertise on the <span className='text-vs-teal tracking-wider italic'>MERN</span> stack. 
                    I'm well versed in both <span className='text-vs-teal'>frontend</span>, and <span className='text-vs-teal'>backend </span> 
                    frameworks and their respective libraries such as <span className='text-vs-teal'>React</span>, Nodejs, Express, NoSql, MySql,
                    Graphql, etc. My works and full breadth of knowledge can be found in my <span className='text-vs-teal'>Works </span> and <span className='text-vs-teal'>About </span>  page.
                </p>
